...
| https://code.claude.com/docs/en/changelog#v2.1.158 | 2026-05-30 | out-of-scope | Bedrock/Vertex auto mode; CSIS uses Anthropic direct API, not Claude Code permission model |
